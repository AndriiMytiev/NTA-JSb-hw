...
// == 2.1 через .key
// console.log("name: ", user.name); // Andrii
// console.log("age: ", user.age); // undefined - свойство отсутствует у объекта

user.age = 18;
// console.log("age: ", user.age); // 18

delete user.age;
// console.log("age: ", user.age); // undefined - свойство удалено
...
function getInputValues(...args) {
    ...
    const [,,mail] = args;
    // console.log("DESTRUCNURING MAIL: ", mail);
    namesDB.push(name);
...
// по-нормальному ES6
const moviesList = {
    moviesList: ["Pacific Rim", "Interstellar"],
    showMovies(){
        console.log("массив movies: ", this.moviesList);
...
moviesList.mapMovies = function(){
    for(let movies of this.moviesList){
